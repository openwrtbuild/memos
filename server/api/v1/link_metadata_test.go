...
type fakeLinkMetadataFetcher func(context.Context, string) (*linkmeta.HTMLMeta, error)

type linkMetadataContextKey struct{}

func (fetch fakeLinkMetadataFetcher) Get(ctx context.Context, url string) (*linkmeta.HTMLMeta, error) {
...
func TestGetLinkMetadata(t *testing.T) {
	...
	service := &APIV1Service{
		linkMetadataFetcher: fakeLinkMetadataFetcher(func(ctx context.Context, url string) (*linkmeta.HTMLMeta, error) {
			require.Same(t, requestContext, ctx)
			require.Equal(t, "https://example.com/article", url)
			return &linkmeta.HTMLMeta{
				Title:       "Example title",
...
func TestGetLinkMetadataFetchError(t *testing.T) {
	service := &APIV1Service{
		linkMetadataFetcher: fakeLinkMetadataFetcher(func(context.Context, string) (*linkmeta.HTMLMeta, error) {
...
func TestGetLinkMetadataInternalURL(t *testing.T) {
	service := &APIV1Service{linkMetadataFetcher: linkmeta.NewHTMLMetaFetcher()}
...
func TestBatchGetLinkMetadataPreservesOrder(t *testing.T) {
	...
	service := &APIV1Service{
		linkMetadataFetcher: fakeLinkMetadataFetcher(func(_ context.Context, url string) (*linkmeta.HTMLMeta, error) {
...
func TestBatchGetLinkMetadataStopsOnError(t *testing.T) {
	...
	service := &APIV1Service{
		linkMetadataFetcher: fakeLinkMetadataFetcher(func(_ context.Context, url string) (*linkmeta.HTMLMeta, error) {
			...
			return &linkmeta.HTMLMeta{Title: url}, nil
		}),
	}
